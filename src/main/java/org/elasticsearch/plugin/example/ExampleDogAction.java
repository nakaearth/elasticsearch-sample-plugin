                                ...
                                new RestActionListener<NodesInfoResponse>(channel) {
                                    ...
                                    public void processResponse(final NodesInfoResponse nodesInfoResponse) {
                                        ...
                                        nodesStatsRequest.clear().jvm(true).os(true).fs(true).indices(true)
                                                .process(true).script(true);
                                        client.admin().cluster().nodesStats(nodesStatsRequest,
                                                new RestResponseListener<NodesStatsResponse>(channel) {
                                                    ...
                                                    public RestResponse buildResponse(
                                                        ...
                                                        return RestTable.buildResponse(
                                                                buildTable(fullId, request, clusterStateResponse,
                                                                        nodesInfoResponse, nodesStatsResponse),
                                                                channel);
                                                    }
                                                });
                                    }
